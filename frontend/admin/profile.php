...
<head>
    ...
    <link rel="stylesheet" href="/axis.com/assets/css/admin/profile.css">
    <link rel="stylesheet" href="/axis.com/assets/css/admin/header.css">
    <link rel="stylesheet" href="/axis.com/assets/css/admin/footer.css">
</head>
<body>
    ...
    <div class="container">
        ...
        <div class="profile" id="profile-section">
            <form action="/axis.com/backend/admin/profile.php" method="post">
        ...
        <div class="account" id="account-section">
            ...
            <form action="/axis.com/backend/admin/profile.php" class="email-form" method="post">
            ...
            <form action="/axis.com/backend/admin/profile.php" class="contact-form" method="post">
        ...
        <div class="password" id="password-section">
            ...
            <form action="/axis.com/backend/admin/profile.php" class="password-form" method="post">
                <div class="account-input">
