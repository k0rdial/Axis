...
$products = $conn->query("SELECT * FROM products WHERE category='women' ORDER BY id ASC");
?>
...
<head>
    ...
    <link rel="stylesheet" href="/axis.com/assets/css/user/women.css">
...
<body>
    ...
    <div class="main-content">
                ...
                <div class="product-track">
                    <?php if ($products && $products->num_rows > 0): ?>
                        <?php while ($row = $products->fetch_assoc()): ?>
                            <a href="/axis.com/admin/product?id=<?= htmlspecialchars($row['id']); ?>" class="product-link" onclick="$_SESSION['active-nav']='women'">
        ...
        <div class="display-product" id="display-product">
            <?php 
                $products2 = $conn->query("SELECT * FROM products WHERE category='women' ORDER BY id ASC");
